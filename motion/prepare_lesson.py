"""Synthesize a revised script into a NEW directory for the Remotion lesson renderer."""
...
if (source.parent/'SOURCES.md').is_file():shutil.copyfile(source.parent/'SOURCES.md',out/'SOURCES.md')
