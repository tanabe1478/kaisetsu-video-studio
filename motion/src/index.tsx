...
import {registerRoot,Composition,AbsoluteFill,useCurrentFrame,useVideoConfig,interpolateColors} from 'remotion';
...
function Lesson({captions}:any){
 ...
 <div style={{position:'absolute',right:50,bottom:17,fontSize:13,color:'#50675d'}}>先頭一致の説明 · {Math.floor(t).toString().padStart(2,'0')} / 40秒</div>
 </AbsoluteFill>;
}

registerRoot(()=> <Composition id="PrefixChange" component={Lesson} width={1280} height={720} fps={24} durationInFrames={954} defaultProps={example}/>);
